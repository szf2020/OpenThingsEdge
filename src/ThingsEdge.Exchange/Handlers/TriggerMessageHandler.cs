...
internal sealed class TriggerMessageHandler(
    ...
    ILogger<TriggerMessageHandler> logger) : IMessageHandler<TriggerMessage>
{
    public async Task HandleAsync(TriggerMessage message, CancellationToken cancellationToken = default)
    {
