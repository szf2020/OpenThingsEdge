...
internal sealed class SwitchMessageHandler(
    ...
    ILogger<SwitchMessageHandler> logger) : IMessageHandler<SwitchMessage>
{
    public async Task HandleAsync(SwitchMessage message, CancellationToken cancellationToken = default)
    {
        // 开关信号
