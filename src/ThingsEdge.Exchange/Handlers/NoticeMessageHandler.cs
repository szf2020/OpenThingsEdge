...
internal sealed class NoticeMessageHandler(
    ...
    ILogger<NoticeMessageHandler> logger) : IMessageHandler<NoticeMessage>
{
    public async Task HandleAsync(NoticeMessage message, CancellationToken cancellationToken = default)
    {
